...
import 'package:trip_prague/core/presentation/widgets/modified_stepper.dart' as modified_stepper;
...
class _RoutineOfDayState extends State<RoutineOfDay> {
  @override
  Widget build(BuildContext context) => modified_stepper.ModifiedStepper(
        controlsBuilder: (BuildContext context, modified_stepper.ControlsDetails controls) =>
